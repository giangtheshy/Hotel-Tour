import { printStars } from "./display-place.js";

const displayButtonPage = (btnContainer, newHotels, activeIndex) => {
  let btns = newHotels.map((_, index) => {
    return `<button class="page-btn ${activeIndex === index ? "active" : "null"}" data-index=${index}>${
      index + 1
    }</button>`;
  });
    ...
    <div class="hotel-center">
      ...
      <div class="hotel-body">
        ...
        ${checkService(
          ...
          ' <span class="elevator-icon"><i class="far fa-caret-square-left"></i></span>'
        )}
        ...
        ${checkService(
          ...
          ' <span class="restaurant-icon"><i class="fas fa-utensils"></i></span>'
        )}
        ${checkService(
          hotel.service.receptionist,
          ' <span class="receptionist-icon"><i class="fas fa-people-arrows"></i></span>'
        )}
        ...
        ${checkService(
          hotel.service.carrental,
          ' <span class="carrental-icon"><i class="fas fa-motorcycle"></i></span>'
        )}
        ...
        <div class="hotel-pay">
          ...
          <div class="view-room">
            <button class="view-room-btn" data-id=${hotel.id}>Book </button>
          </div>
        </div>
      </div>
    </div>
...
export { paginate, displayButtonPage, displayHotels };
